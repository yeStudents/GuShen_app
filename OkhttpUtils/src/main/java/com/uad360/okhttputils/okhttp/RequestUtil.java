...
import com.uad360.okhttputils.ssl.SSLUtil;
...
class RequestUtil {
    ...
    RequestUtil(String methodType, String url, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackUtil callBack, InputStream[] certificates) {
        this(methodType, url, null, null, null, null, null, null, paramsMap, headerMap, callBack, certificates);
    }

    RequestUtil(String methodType, String url, String jsonStr, Map<String, String> headerMap, CallBackUtil callBack, InputStream[] certificates) {
        this(methodType, url, jsonStr, null, null, null, null, null, null, headerMap, callBack, certificates);
    }

    RequestUtil(String methodType, String url, Map<String, String> paramsMap, File file, String fileKey, String fileType, Map<String, String> headerMap, CallBackUtil callBack, InputStream[] certificates) {
        this(methodType, url, null, file, null, fileKey, null, fileType, paramsMap, headerMap, callBack, certificates);
    }

    RequestUtil(String methodType, String url, Map<String, String> paramsMap, List<File> fileList, String fileKey, String fileType, Map<String, String> headerMap, CallBackUtil callBack, InputStream[] certificates) {
        this(methodType, url, null, null, fileList, fileKey, null, fileType, paramsMap, headerMap, callBack, certificates);
    }

    RequestUtil(String methodType, String url, Map<String, String> paramsMap, Map<String, File> fileMap, String fileType, Map<String, String> headerMap, CallBackUtil callBack, InputStream[] certificates) {
        this(methodType, url, null, null, null, null, fileMap, fileType, paramsMap, headerMap, callBack, certificates);
    }

    private RequestUtil(String methodType, String url, String jsonStr, File file, List<File> fileList, String fileKey, Map<String, File> fileMap, String fileType, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackUtil callBack, InputStream[] certificates) {
     ...
     * 创建OKhttpClient实例。
     */
    private void getInstance(InputStream[] certificates) {
        OkHttpClient.Builder builder = new OkHttpClient.Builder();
        if (certificates != null) {

            builder.sslSocketFactory(SSLUtil.getSSLSocketFactory(certificates));
//            builder.sslSocketFactory(SSLUtil.getSSLSocketFactory(new Buffer().writeUtf8(CER).inputStream()));
        ...
        if (mFile != null || mfileList != null || mfileMap != null) {//先判断是否有文件，
            ...
            //设置参数
            switch (mMetyodType) {
                case com.uad360.okhttputils.okhttp.OkhttpUtil.METHOD_GET:
                    setGetParams();
                    break;
                case com.uad360.okhttputils.okhttp.OkhttpUtil.METHOD_POST:
                    mRequestBuilder.post(getRequestBody());
                    break;
                case com.uad360.okhttputils.okhttp.OkhttpUtil.METHOD_PUT:
                    mRequestBuilder.put(getRequestBody());
                    break;
                case com.uad360.okhttputils.okhttp.OkhttpUtil.METHOD_DELETE:
